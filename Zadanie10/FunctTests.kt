...
class ExampleInstrumentedTest
{
    ...
    fun sixthTest()
    {
        ...
        onView(withId(R.id.textView)).check(matches(withText("9")))
        onView(withId(R.id.button9)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("99")))
        onView(withId(R.id.buttonMultiply)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("99*")))
        onView(withId(R.id.button1)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("99*1")))
        onView(withId(R.id.buttonResult)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("99")))
    }
    fun seventhTest()
    {
        ...
        onView(withId(R.id.button5)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("45")))
        onView(withId(R.id.buttonDiv)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("45/")))
        onView(withId(R.id.button1)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("45/1")))
        onView(withId(R.id.buttonResult)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("45")))
    }
    fun eighthTest()
    {
        ...
        onView(withId(R.id.button2)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("222")))
        onView(withId(R.id.buttonMultiply)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("222*")))
        onView(withId(R.id.button0)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("222*0")))
        onView(withId(R.id.buttonResult)).perform(click())
    ...
    fun ninthTest()
    {
        ...
        onView(withId(R.id.textView)).check(matches(withText("8-")))
        onView(withId(R.id.button8)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("8-8")))
        onView(withId(R.id.buttonResult)).perform(click())
        onView(withId(R.id.textView)).check(matches(withText("0")))
    }
    fun tenthTest()
